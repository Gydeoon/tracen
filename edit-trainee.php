            ...
            <div class="w-full md:w-2/3 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-5 gap-3">
                        <input type="number" name="stat_speed" id="stat_speed" value="<?php echo $trainee['stat_speed']; ?>" class="clean-input text-center font-bold !px-1 text-blue-600 focus:!border-blue-500" required>
                        <input type="number" name="stat_stamina" id="stat_stamina" value="<?php echo $trainee['stat_stamina']; ?>" class="clean-input text-center font-bold !px-1 text-pink-600 focus:!border-pink-500" required>
                        <input type="number" name="stat_power" id="stat_power" value="<?php echo $trainee['stat_power']; ?>" class="clean-input text-center font-bold !px-1 text-orange-600 focus:!border-orange-500" required>
                        <input type="number" name="stat_guts" id="stat_guts" value="<?php echo $trainee['stat_guts']; ?>" class="clean-input text-center font-bold !px-1 text-red-600 focus:!border-red-500" required>
                        <input type="number" name="stat_wit" id="stat_wit" value="<?php echo $trainee['stat_wit']; ?>" class="clean-input text-center font-bold !px-1 text-green-600 focus:!border-green-500" required>
                    </div>
                </div>
